...
export const P1C1_GP: Mail = {
    id: "p1c1_gp",
    author: MailAuthors.Harry_Lester,
    object: "My granson...",
...
export const SUPPORT_THXREM: Mail = {
    id: "support:thxrem",
    author: MailAuthors.Jolyne_Team,
    object: "PREMIUM",
...
BTW today somes **bandits** attacked my sister, but I can't do anything since i'm in the hospital. Please beat their asses for me !1!1!!1`,
    date: Date.now(),
